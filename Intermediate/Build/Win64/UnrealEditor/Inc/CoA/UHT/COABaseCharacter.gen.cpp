...
void Z_Construct_UClass_ACOABaseCharacter_Statics::NewProp_bStaminaDrained_SetBit(void* Obj)
{
	((ACOABaseCharacter*)Obj)->bStaminaDrained = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ACOABaseCharacter_Statics::NewProp_bStaminaDrained = { "bStaminaDrained", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ACOABaseCharacter), &Z_Construct_UClass_ACOABaseCharacter_Statics::NewProp_bStaminaDrained_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bStaminaDrained_MetaData), NewProp_bStaminaDrained_MetaData) };
void Z_Construct_UClass_ACOABaseCharacter_Statics::NewProp_bRunning_SetBit(void* Obj)
{
	((ACOABaseCharacter*)Obj)->bRunning = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ACOABaseCharacter_Statics::NewProp_bRunning = { "bRunning", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ACOABaseCharacter), &Z_Construct_UClass_ACOABaseCharacter_Statics::NewProp_bRunning_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bRunning_MetaData), NewProp_bRunning_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ACOABaseCharacter_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ACOABaseCharacter_Statics::NewProp_bStaminaDrained,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ACOABaseCharacter_Statics::NewProp_bRunning,
};
...
struct Z_CompiledInDeferFile_FID_Users_Alimert_Documents_Unreal_Projects_CoA_Source_CoA_Public_COABaseCharacter_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ACOABaseCharacter, ACOABaseCharacter::StaticClass, TEXT("ACOABaseCharacter"), &Z_Registration_Info_UClass_ACOABaseCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACOABaseCharacter), 698089637U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Alimert_Documents_Unreal_Projects_CoA_Source_CoA_Public_COABaseCharacter_h_1572348742(TEXT("/Script/CoA"),
